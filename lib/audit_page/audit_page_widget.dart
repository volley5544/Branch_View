...
class AuditPageWidget extends StatefulWidget {
  const AuditPageWidget({
    Key key,
    this.location1,
  }) : super(key: key);
  ...
  @override
  _AuditPageWidgetState createState() => _AuditPageWidgetState();
}

class _AuditPageWidgetState extends State<AuditPageWidget> {
  ...
  void initState() {
    ...
    textController3 = TextEditingController(text: 'ฝ่ายตรวจสอบ');
