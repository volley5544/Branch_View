...
class DebtTrackPageWidget extends StatefulWidget {
  const DebtTrackPageWidget({
    Key key,
    this.location1,
  }) : super(key: key);
  ...
  @override
  _DebtTrackPageWidgetState createState() => _DebtTrackPageWidgetState();
}

class _DebtTrackPageWidgetState extends State<DebtTrackPageWidget> {
  ...
  void initState() {
    ...
    textController3 = TextEditingController(text: 'ติดตามหนี้');
